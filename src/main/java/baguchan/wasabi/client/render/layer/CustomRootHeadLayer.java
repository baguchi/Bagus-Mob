package baguchan.wasabi.client.render.layer;
...
public class CustomRootHeadLayer<T extends LivingEntity, M extends HierarchicalModel<T> & HeadedModel> extends RenderLayer<T, M> {
	...
	public CustomRootHeadLayer(RenderLayerParent<T, M> p_234829_, EntityModelSet p_234830_, ItemInHandRenderer p_234831_) {
		this(p_234829_, p_234830_, 1.0F, 1.0F, 1.0F, p_234831_);
	}

	public CustomRootHeadLayer(RenderLayerParent<T, M> p_234822_, EntityModelSet p_234823_, float p_234824_, float p_234825_, float p_234826_, ItemInHandRenderer p_234827_) {
		super(p_234822_);
	...
	public void render(PoseStack p_116731_, MultiBufferSource p_116732_, int p_116733_, T p_116734_, float p_116735_, float p_116736_, float p_116737_, float p_116738_, float p_116739_, float p_116740_) {
		...
		if (!itemstack.isEmpty()) {
			...
			this.getParentModel().root().translateAndRotate(p_116731_);
