...
public class BoarSensor extends Sensor<HunterBoar> {
    public BoarSensor() {
    }
    ...
    @Override
    protected void doTick(ServerLevel p_26659_, HunterBoar p_26660_) {
        ...
        for (LivingEntity livingentity : nearestvisiblelivingentities.findAll((p_186150_) -> !p_186150_.isBaby() && (p_186150_ instanceof Piglin || p_186150_ instanceof Hoglin))) {
    ...
    private Optional<BlockPos> findNearestRepellent(ServerLevel p_26665_, HunterBoar p_26666_) {
