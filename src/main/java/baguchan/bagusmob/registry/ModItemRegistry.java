...
public class ModItemRegistry {
	...
	public static final RegistryObject<Item> VILER_VEX_SPAWNEGG = ITEM_REGISTRY.register("viler_vex_spawn_egg", () -> new ForgeSpawnEggItem(ModEntityRegistry.VILER_VEX, 0x959B9B, 0x7341BC, (new Item.Properties())));
