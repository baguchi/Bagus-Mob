...
public class ModItemRegistry {
    ...
    public static final Supplier<Item> NINJA_HOOD = ITEM_REGISTRY.register("ninja_hood", () -> new NinjaArmorItem(ArmorItem.Type.HELMET, (new Item.Properties())));
    ...
    public static final Supplier<Item> SAMURAI_SPAWNEGG = ITEM_REGISTRY.register("samurai_spawn_egg", () -> new DeferredSpawnEggItem(ModEntityRegistry.SAMURAI, 0x323237, 0x3C3E43, (new Item.Properties())));
    ...
    public static final Supplier<Item> BEAST_CUDGEL = ITEM_REGISTRY.register("beast_cudgel", () -> new BeastWeaponItem((new Item.Properties()).durability(520).rarity(Rarity.UNCOMMON)));
