package baguchan.bagusmob.client.model;// Made with Blockbench 4.8.1
// Exported for Minecraft version 1.17 or later with Mojang mappings
// Paste this class into your mod and generate all required imports


import bagu_chan.bagus_lib.client.layer.IArmor;
import baguchan.bagusmob.client.animation.RudeHogAnimations;
...
public class RudeHogModel<T extends RudeHog> extends HierarchicalModel<T> implements ArmedModel, IArmor {
    ...
    public void setupAnim(T entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        if (this.riding) {
            ...
            this.animateWalk(RudeHogAnimations.WALK, limbSwing, limbSwingAmount, 2.0F, 2.5F);
